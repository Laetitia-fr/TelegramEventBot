export const i18n = {
  ...
  help: {
    ...
    event: '<b>/event</b> suivi de la description avec une date au format dd/MM/AAAA pour créer un événement.\nExemple: /event Réunion le 15/5/2023 à 10h à Ste-Colombe',
    ...
    date: '<b>/date</b> (réservé aux administrateurs) suivi de l\'ID de l\'événement et la date dd/MM/AAAA pour ajouter ou modifier la date d\'un événement\nExemple: /date 5 15/5/2023',
